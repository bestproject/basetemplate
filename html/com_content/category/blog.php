	...
	<?php if (!empty($this->intro_items)) : ?>
        <div class="items row">
			<?php foreach ($this->intro_items as $key => &$item) : ?>
                ...
                <article
                        class="col-12 col-lg-<?php echo round(12 / $this->columns); ?> pb-3 <?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>"
                        itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
					<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
	...
	<?php if (($this->params->def('show_pagination', 1) == 1 || ($this->params->get('show_pagination') == 2)) && ($this->pagination->get('pages.total') > 1)) : ?>
        <div class="pagination-wrapper pt-3">
			<?php if ($this->params->def('show_pagination_results', 1)) : ?>
                <div class="counter py-2 text-center"> <?php echo $this->pagination->getPagesCounter(); ?> </div>
			<?php endif; ?>
